...
namespace MailmanUtilities
{
    ...
    public class MultiDict<Key, Value> : IDisposable where Key : IComparable
    {
        ...
        public MultiDict()
        {
            ...
            {
                throw new MultiDictException(ex, ex.Message);
            }
        }
        ...
        public MultiDict(ref MultiDict<Key, Value> DictToCopy)
        {
            try
            {
                CurrentKey = default(Key);
    ...
    /// </summary>
    public class MultiDictException : Exception
    {
        /// <summary>
        /// 
        /// </summary>
        public MultiDictException()
            : base()
        {
        }
        ...
        public MultiDictException(Exception ExceptionParam, string ExMessage)
        ...
        public MultiDictException(string Message)
            : base(Message)
        {
        ...
        public MultiDictException(System.Runtime.Serialization.SerializationInfo info,
